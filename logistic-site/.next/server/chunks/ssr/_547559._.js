...
//   const [orders, setOrders] = useState<{ id: number; pickup: string; destination: string; weight: number; status: string }[]>([]); // Orders state
//   const [isOrderFormOpen, setIsOrderFormOpen] = useState(false); // Order form modal toggle
//   const [trackingInfo, setTrackingInfo] = useState<{ trackingNumber: string; status: string; estimatedDelivery: string } | null>(null); // Tracking info state
//   // Handle order submission
//   interface Order {
//     id: number;
//     pickup: string;
...
//   }
//   const handleTrackOrder = (orderId: number): void => {
//     const order = orders.find((order) => order.id === orderId);
//     if (order) {
//       const trackingDetails: TrackingDetails = {
//         trackingNumber: `TRACK-${order.id}`,
//         status: order.status,
//         estimatedDelivery: "2024-12-30", // Placeholder date for tracking
//       };
//       setTrackingInfo(trackingDetails); // Set tracking info in state to show in modal
//     }
//   };
//   const handleOrderSubmit = (event: FormEvent): void => {
//     event.preventDefault();
...
//                   Trust, Reliability, and Excellence Delivered.
//                 </p>
//                   <button className="mt-6 bg-yellow-500 text-black px-6 py-3 rounded hover:bg-yellow-600 hover:underline" onClick={() => setActivePage("contact")}> Get a Quote
//                   </button>
//               </div>
//             </div>
//             <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
...
//                           <th className="border p-2">Weight</th>
//                           <th className="border p-2">Status</th>
//                           <th className="border p-2">Track Order</th>
//                         </tr>
//                       </thead>
//                       <tbody>
//                         {orders.map((order) => (
...
//                             <td className="border p-2">{order.weight} kg</td>
//                             <td className="border p-2">{order.status}</td>
//                             <td className="border p-2"><button onClick={() => handleTrackOrder(order.id)}className="bg-blue-500 text-white px-4 py-2 rounded"> Track </button> </td>
//                           </tr>
//                         ))}
//                       </tbody>
//                     </table>
...
//                 );
// }
// Logistics App - Initial Structure
__turbopack_esm__({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                children: "Welcome to Logistics App"
            }, void 0, false, {
                fileName: "[project]/src/app/page.tsx",
                lineNumber: 1332,
                columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                children: "Your orders and analytics will appear here."
            }, void 0, false, {
                fileName: "[project]/src/app/page.tsx",
                lineNumber: 1333,
                columnNumber: 13
...
// Main App Component
function App() {
    const [activePage, setActivePage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])('Dashboard');
    const pages = {
        Dashboard: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(Dashboard, {}, void 0, false, {
            fileName: "[project]/src/app/page.tsx",
            lineNumber: 1376,
            columnNumber: 20
        }, this),
        Orders: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(Orders, {}, void 0, false, {
            fileName: "[project]/src/app/page.tsx",
            lineNumber: 1377,
            columnNumber: 17
        }, this)
